...
//Js to insert footer
const footerMsg = `&copy; ${yr} Raymund Antrone<br>- |WDD330 Final Project| -`;
  ...
  async function getData() {
    try {
      const res = await fetch(
        `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/Philippines?unitGroup=metric&key=WJYSGT432NHLEY4HY4FW58P2P `
      );
